...
import styles from "./tripad.module.scss";
import image from "../../images/tripadvisor.png";

function Tripad() {
  return (
    // <Wrapper>
    <div className={styles["tripad"]}>
      <div className={styles["tripad-container"]}>
        <div className={styles["left-tripad"]}>
          <img src={image} alt="" />
        ...
        <div className={styles["right-tripad"]}>
          <div className={styles["tripad-img"]}>
            <img src={image2} alt="" />
