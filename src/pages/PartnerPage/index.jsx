        ...
        <div className={styles["why-container"]}>
          ...
          <div className={styles["whys"]}>
            ...
            <div className={styles["why"]}>
              ...
              <p>
                We have optimized our processes to ensure that you get the best
                value for your time. Say goodbye to empty miles and say hello to
                a more optimized transfer allocation system. We do all the heavy
            ...
            <div className={styles["benefit"]}>
              ...
              <div>
                ...
                <p>
                  ...
                  vehicles to work at your pace. When you choose transfers that
                  suit you, you will be able to increase your efficiency .
                </p>
              </div>
            </div>
            <div className={styles["benefit"]}>
              ...
              <div>
                ...
                <p>
                  ...
                  and decline transfers based on the in-app rates. As a partner
                  you are not mandated to accept the transfers we offer and this
                  does not affect fees or rates.
                </p>
              </div>
            </div>
            <div className={styles["benefit"]}>
